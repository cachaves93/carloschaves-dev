        ...
        c.LIRenderAll = function() {
            function t(a) { 
                ...
                .filter( function(a) {
                    ...
                    function(a) {
                        ...
                        ) + "\x3d" + encodeURIComponent(a.value)
                    }
                )
            }
            ...
            function q(a,d) { 
                if(
                    ...
                    ||r[a.src]
                    ||d 
                    && (!d || a.getAttribute("data-isartdeco"))
                ) {
                    for(var b=0,e=a.childNodes;b<e.length;) {
                        q(e[b++],d)
                    }
                } else {
                    a.parentNode.replaceChild(w(a),a),r[a.src]=!0;
                }
                return a
            }
            ...
            function x() {
                if(n>=k&&0<k||n>=h.length) {
                    delete c.LIBadgeCallback,p.map(function(a){document.body.removeChild(a)})
                }
            }
            ...
            for(l=h.length;g<l;g++) {
                ...
                s||(k++,m.setAttribute("data-rendered",!0),
                u(m));
            }
            c.LIBadgeCallback = function(a,d) {
                ...
                for (l=h.length;b<l;b++) {
                    ...
                    c.innerHTML=a,e.appendChild(c),q(e,g))
                };
                x()
            }
        };
